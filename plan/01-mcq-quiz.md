# Feature 01 — MCQ Quiz (TODO & Status)
...
- **Site Settings** — `play/page.tsx` reads `quiz.defaults.levelTimers` via `SettingsService` (fallback hardcoded).
