...
Superseded audit/plan files moved here during the documentation consolidation. Their findings have been verified and folded into the authoritative docs: `docs/features/` (per-feature, full-stack) and `docs/platform/` (cross-cutting). Do not update these; edit the feature/platform files instead.
