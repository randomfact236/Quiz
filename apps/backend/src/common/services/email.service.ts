...
<body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; background-color: #f5f5f5;">
  <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="background-color: #f5f5f5;">
          ...
          <tr>
            <td style="padding: 32px;">
              ...
              <p style="margin: 0 0 24px 0; font-size: 15px; line-height: 1.6; color: #4b5563;">
                Welcome to AI Quiz! Click the button below to confirm your email address:
              </p>
              ...
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
                <tr>
                  <td align="center" style="padding: 0 0 24px 0;">
                    <a href="${verifyUrl}" target="_blank" style="display: inline-block; padding: 14px 28px; background-color: #4F46E5; color: #ffffff; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 15px;">
                      Verify Email
                    </a>
                  </td>
                </tr>
    ...
    if (!this.resend) {
      ...
      return {
        success: true,
        message: 'Email service not configured. Verification link logged to console.',
      };
    }
    ...
    try {
      const { data, error } = await this.resend.emails.send({
        from: this.fromEmail,
        to: [to],
        subject: 'Verify your AI Quiz email address',
        html: emailHtml,
      });
