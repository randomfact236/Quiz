...
export function RiddleMcqContainer() {
  ...
  const handleCategorySubmit = async (data: any) => {
    if (categoryModal.category) {
      await categoriesQuery.updateAsync({
    ...
    return (
      <div className="p-6">
        <div className="p-4 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg">
          <p className="text-red-700 dark:text-red-300 font-medium">Failed to load categories</p>
  ...
  return (
    <div className="space-y-6 p-6">
      <div className="mb-6 flex items-center justify-between">
        <div>
          <h3 className="text-lg font-semibold">🧩 Riddle Categories</h3>
      ...
      <CategoryModal
        ...
        isSubmitting={categoriesQuery.isPending}
      />
