    ...
    <>
      ...
      <CollapsibleRows className="flex flex-wrap items-center gap-2">
        ...
        <button
          ...
          className={`rounded-lg px-3 py-1.5 text-sm font-medium transition-colors ${!filters.subject || filters.subject === 'all' ? 'bg-indigo-500 text-white' : 'bg-white dark:bg-secondary-800 text-gray-700 dark:text-secondary-200 border border-gray-300 dark:border-secondary-600 hover:bg-gray-100 dark:hover:bg-secondary-800 dark:hover:bg-secondary-800'}`}
        >
          All ({filterCounts?.total ?? 0})
        </button>
