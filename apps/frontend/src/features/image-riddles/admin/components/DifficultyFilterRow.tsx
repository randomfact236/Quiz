    ...
    <div className="mb-4 rounded-xl bg-white dark:bg-secondary-800 p-4 shadow-md">
      <div className="flex flex-wrap items-center gap-2">
        ...
        <button
          ...
          className={`px-3 py-1.5 rounded-lg text-sm font-medium transition-colors ${filterDifficulty === '' ? 'bg-indigo-500 text-white shadow-sm' : 'bg-gray-100 dark:bg-secondary-800 text-gray-700 dark:text-secondary-200 hover:bg-gray-200 dark:hover:bg-secondary-700 dark:hover:bg-secondary-700'}`}
        >
        ...
        {DIFFICULTIES.map((diff) => {
          ...
          return (
            <button
              ...
              className={`px-3 py-1.5 rounded-lg text-sm font-medium capitalize transition-all ${isActive ? 'bg-indigo-500 text-white shadow-sm' : 'bg-gray-100 dark:bg-secondary-800 text-gray-700 dark:text-secondary-200 hover:bg-gray-200 dark:hover:bg-secondary-700 dark:hover:bg-secondary-700'}`}
            >
