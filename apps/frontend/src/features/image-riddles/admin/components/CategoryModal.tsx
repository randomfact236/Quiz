...
export default function CategoryModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
      <div className="w-full max-w-md rounded-2xl bg-white dark:bg-secondary-800 p-6 shadow-2xl animate-in fade-in zoom-in duration-200">
        ...
        <div className="space-y-5">
          <div>
            <label className="mb-1.5 block text-sm font-semibold text-gray-700 dark:text-secondary-200">
              Category Name
            </label>
            <input
              type="text"
              ...
              className="w-full rounded-xl border border-gray-200 dark:border-secondary-700 px-4 py-2.5 text-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all outline-none"
          ...
          <div>
            ...
            <div className="flex gap-2">
              <input
                ...
                className="w-20 rounded-xl border border-gray-200 dark:border-secondary-700 px-4 py-2.5 text-center text-xl focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all outline-none"
              />
              <div className="flex-1 rounded-xl bg-gray-50 dark:bg-secondary-800 px-4 py-2.5 text-xs text-gray-500 dark:text-secondary-400 flex items-center">
