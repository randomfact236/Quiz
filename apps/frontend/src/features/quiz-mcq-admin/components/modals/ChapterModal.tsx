...
import type { QuizChapter, QuizSubject } from '@/lib/quiz-mcq-api';
...
export function ChapterModal({ open, chapter, subjectId, subjects, onClose }: ChapterModalProps) {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 bg-white dark:bg-secondary-800 rounded-2xl shadow-2xl w-full max-w-md max-h-[85vh] overflow-hidden flex flex-col">
