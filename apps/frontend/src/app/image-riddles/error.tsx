...
export default function ImageRiddlesError({
  error,
  reset,
}: {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-blue-50 dark:bg-blue-500/10 px-4">
      <div className="w-full max-w-md rounded-2xl bg-white dark:bg-secondary-800 p-8 text-center shadow-xl">
        <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-blue-100 dark:bg-blue-500/20 text-4xl">
          🖼️
        </div>
        ...
        <p className="mb-6 text-sm text-gray-500 dark:text-secondary-400">
          {error?.message || 'Something went wrong loading the image riddles. Please try again.'}
        </p>
