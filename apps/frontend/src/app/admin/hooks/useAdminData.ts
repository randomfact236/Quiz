...
const initialQuestions: Record<string, Question[]> = {
  ...
  math: [
    { id: '1', question: 'What is 15 × 8?', optionA: '110', optionB: '120', optionC: '130', optionD: '140', correctAnswer: 'B', level: 'easy', chapter: 'Multiplication', status: 'published' as const },
    { id: '2', question: 'What is the square root of 144?', optionA: '10', optionB: '11', optionC: '12', optionD: '13', correctAnswer: 'C', level: 'easy', chapter: 'Square Roots', status: 'published' as const },
  ],
  history: [
