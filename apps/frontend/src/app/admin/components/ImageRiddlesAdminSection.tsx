...
export function ImageRiddlesAdminSection(): JSX.Element {
  ...
  const statusCounts = useMemo<StatusCounts>(() => {
    const filtered = imageRiddles.filter((riddle) => {
      ...
      const matchesSearch =
        !searchTerm || riddle.title.toLowerCase().includes(searchTerm.toLowerCase());
  ...
  const paginatedRiddles = useMemo(
    () => filteredRiddles.slice((currentPage - 1) * ITEMS_PER_PAGE, currentPage * ITEMS_PER_PAGE),
  ...
  }, [importPreview, categories, loadData]);
  ...
  const handleAddRiddle = useCallback(async () => {
    if (
      ...
      !riddleForm.imageUrl.trim() ||
      !riddleForm.answer.trim() ||
      !riddleForm.categoryName.trim()
    ) {
      return;
    }
  ...
  }, [selectedRiddle, riddleForm, categoryIdByName, categories]);
  ...
  const handleTrashImageRiddle = useCallback(async () => {
    ...
    try {
      if (selectedRiddle.status === 'trash') {
        ...
        await bulkActionImageRiddles([selectedRiddle.id], 'delete');
        ...
        const previousStatus = selectedRiddle.status;
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="overflow-hidden rounded-xl bg-white shadow-md border border-gray-100">
        <table className="min-w-full divide-y divide-gray-200">
          ...
          <tbody className="divide-y divide-gray-100 bg-white">
            ...
            {!isLoadingData && paginatedRiddles.length === 0 && (
              <tr>
      ...
      {filteredRiddles.length > 0 && (
        <div className="flex items-center justify-between border-t bg-gray-50 px-4 py-3 mt-4">
          <p className="text-sm text-gray-500">
            Showing {Math.min((currentPage - 1) * itemsPerPage + 1, filteredRiddles.length)} -{' '}
            {Math.min(currentPage * itemsPerPage, filteredRiddles.length)} of{' '}
            {filteredRiddles.length} items
          </p>
          ...
          >
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    onChange={(e) =>
                      setRiddleForm((prev) => ({ ...prev, imageUrl: e.target.value }))
                    }
                    className="w-full rounded-lg border border-gray-300 px-4 py-2 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-200"
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setRiddleForm((prev) => ({
                        ...prev,
                        difficulty: e.target.value as RiddleFormState['difficulty'],
                      }))
                    }
                    className="w-full rounded-lg border border-gray-300 px-4 py-2 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-200"
                    aria-required="true"
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setRiddleForm((prev) => ({ ...prev, timerSeconds: e.target.value }))
                    }
                    className="w-full rounded-lg border border-gray-300 px-4 py-2 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-200"
              ...
              <div className="grid grid-cols-2 gap-4">
                  ...
                  <select
                    ...
                    onChange={(e) => {
                      ...
                      setRiddleForm((prev) => ({
                        ...
                        categoryEmoji: cat ? cat.emoji : prev.categoryEmoji,
                      }));
                    }}
                    className="w-full rounded-lg border border-gray-300 px-4 py-2 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-200"
                    aria-required="true"
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setRiddleForm((prev) => ({ ...prev, categoryEmoji: e.target.value }))
                    }
                    className="w-full rounded-lg border border-gray-300 px-4 py-2 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-200"
                    placeholder="e.g., 🔍"
                  />
              ...
              <div className="flex items-center gap-4 border-t border-slate-100 pt-4 mt-4">
                ...
                <label className="flex items-center gap-2 mt-6 cursor-pointer">
                  <input
                    ...
                    onChange={(e) =>
                      setRiddleForm((prev) => ({ ...prev, showTimer: e.target.checked }))
                    }
                ...
                <label className="flex items-center gap-2 mt-6 cursor-pointer">
                  <input
                    ...
                    onChange={(e) =>
                      setRiddleForm((prev) => ({ ...prev, isActive: e.target.checked }))
                    }
                    className="rounded border-gray-300 w-4 h-4 text-blue-600"
                  />
              ...
              <div className="flex gap-2 pt-4">
                ...
                >
                  {isSaving ? 'Saving...' : showAddModal ? 'Add Riddle' : 'Save Changes'}
                </button>
              </div>
            </div>
          </div>
      ...
      {showDeleteCategoryConfirm && (
        <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
          <div className="w-full max-w-sm rounded-2xl bg-white p-6 shadow-2xl animate-in fade-in zoom-in duration-200">
            ...
            <h3 className="mb-2 text-lg font-bold text-gray-900 text-left px-0">
              Delete Category?
            </h3>
      ...
      <MediaPicker
        ...
        onSelect={({ url }) => setRiddleForm((prev) => ({ ...prev, imageUrl: url }))}
      />
      ...
      {showSyncConfirmModal && (
        <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
          <div className="w-full max-w-sm rounded-2xl bg-white p-6 shadow-2xl animate-in fade-in zoom-in duration-200">
            ...
            <p className="mb-6 text-sm text-gray-600">
              This will discard local edits and re-fetch all riddles and categories from the
              database. Unsaved changes will be lost.
            </p>
            <div className="flex gap-3">
              <button
