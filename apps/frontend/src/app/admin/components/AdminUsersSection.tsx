  ...
  return (
    <div>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        <div className="bg-white dark:bg-secondary-800 rounded-xl shadow-sm p-4 border border-slate-200 dark:border-secondary-700">
          <p className="text-sm text-slate-500 dark:text-secondary-400">Total Users</p>
          <p className="text-2xl font-bold text-slate-900 dark:text-secondary-100">
            {registeredUsers.length + guestUsers.length}
          </p>
        </div>
        <div className="bg-white dark:bg-secondary-800 rounded-xl shadow-sm p-4 border border-slate-200 dark:border-secondary-700">
          <p className="text-sm text-slate-500 dark:text-secondary-400">Registered</p>
          <p className="text-2xl font-bold text-green-600 dark:text-green-300">
            {registeredUsers.length}
          </p>
        </div>
        <div className="bg-white dark:bg-secondary-800 rounded-xl shadow-sm p-4 border border-slate-200 dark:border-secondary-700">
          <p className="text-sm text-slate-500 dark:text-secondary-400">Guests</p>
      ...
      <div className="flex flex-wrap gap-3 mb-6">
        <input
          ...
          className="px-4 py-2 rounded-lg border border-slate-300 dark:border-secondary-600 flex-1 min-w-[200px]"
        />
        <button
          onClick={fetchUsers}
      ...
      <div className="bg-white dark:bg-secondary-800 rounded-xl shadow-sm border border-slate-200 dark:border-secondary-700 overflow-hidden">
        <table className="min-w-full">
          <thead className="bg-slate-50 dark:bg-secondary-800 border-b border-slate-200 dark:border-secondary-700">
            <tr>
              {activeTab === 'registered' ? (
                <>
                  <th className="px-6 py-3 text-left text-xs font-semibold text-slate-600 dark:text-secondary-300 uppercase">
                    User
                  </th>
                  <th className="px-6 py-3 text-left text-xs font-semibold text-slate-600 dark:text-secondary-300 uppercase">
                    Registered
                  ...
                  <td className="px-6 py-4">
                    {'email' in user ? (
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="font-medium text-slate-900 dark:text-secondary-100">
                            {user.name || '-'}
                          </p>
                      ...
                      <p className="font-mono text-sm text-slate-600 dark:text-secondary-300">
                    ...
                    <>
                      <td className="px-6 py-4">
                        <select
                          ...
                          className="rounded-md border border-slate-300 dark:border-secondary-600 px-2 py-1 text-sm"
                      ...
                      <td className="px-6 py-4">
                        <button
                          ...
                          className="flex items-center gap-1 rounded-md bg-red-50 dark:bg-red-500/10 px-2 py-1 text-xs font-medium text-red-600 dark:text-red-300 hover:bg-red-100 dark:hover:bg-red-500/20"
        ...
        {totalPages > 1 && (
          <div className="px-6 py-4 border-t border-slate-200 dark:border-secondary-700 flex items-center justify-between">
            <p className="text-sm text-slate-500 dark:text-secondary-400">
            ...
            <div className="flex gap-2">
              <button
                ...
                className="px-3 py-1 rounded border border-slate-300 dark:border-secondary-600 disabled:opacity-50"
              >
                Prev
              </button>
              <button
