...
export default function QuizError({
    ...
    return (
        <div className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-b from-[#A5A3E4] to-[#BF7076] px-4">
            <div className="w-full max-w-md rounded-2xl bg-white p-8 text-center shadow-xl">
                <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-yellow-100 text-4xl">
                    🎯
                </div>
                <h1 className="mb-2 text-2xl font-bold text-gray-800">Quiz Error</h1>
