...
export default function LoginPage() {
  ...
  useEffect(() => {
    // Google OAuth returns a single-use, 60-second code — never tokens in
    // the URL. Exchange it, then strip it from the address bar.
    ...
    authService
      ...
      .catch(() => {
        if (cancelled) return;
        setOauthError('Sign-in link expired. Please try Google sign-in again.');
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <input
                  ...
                  className="h-4 w-4 text-indigo-600 dark:text-indigo-300 focus:ring-indigo-500 border-slate-300 dark:border-slate-600 dark:bg-slate-700 rounded"
                />
                <label
                  htmlFor="remember-me"
