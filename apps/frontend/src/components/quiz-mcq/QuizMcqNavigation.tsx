...
interface QuizMcqNavigationProps {
...
export function QuizMcqNavigation({
  canGoPrevious,
  canGoNext,
  isLastQuestion,
  ...
  onSubmit,
  isSubmitting = false,
}: QuizMcqNavigationProps): JSX.Element {
      ...
      {isLastQuestion ? (
        ...
        >
          {isSubmitting ? (
            ...
            <>
              {allAnswered ? <CheckCircle className="h-5 w-5" /> : <Flag className="h-5 w-5" />}
