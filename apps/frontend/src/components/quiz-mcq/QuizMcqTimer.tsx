...
export function QuizMcqTimer({
  timeRemaining,
  totalTime,
  isRunning: _isRunning,
  variant = 'bar',
}: QuizMcqTimerProps): JSX.Element {
  ...
  return (
    <div className="w-full">
      <div className="mb-2 flex items-center justify-between">
        <div
          className={`flex items-center gap-2 font-mono text-lg font-semibold ${getTextClass()}`}
        >
          <Clock className="h-5 w-5" />
          {formatTimeMMSS(timeRemaining)}
        </div>
