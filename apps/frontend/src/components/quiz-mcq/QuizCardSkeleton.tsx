...
export default function QuizCardSkeleton() {
  return (
    <div
      aria-hidden="true"
      className="flex flex-col items-center rounded-2xl bg-white/95 dark:bg-secondary-800/95 p-6 text-center shadow-lg"
    >
      <div className="h-12 w-12 rounded-full bg-gray-200 dark:bg-secondary-700 animate-pulse" />
      <div className="mt-3 h-4 w-3/4 rounded bg-gray-200 dark:bg-secondary-700 animate-pulse" />
