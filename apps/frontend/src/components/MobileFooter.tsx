              ...
              {activeDrawer === DRAWER_TYPES.RIDDLES &&
                (loadingRiddles ? (
                  <div className="col-span-full py-8 flex flex-col items-center gap-2">
                    <Loader2 className="animate-spin text-purple-600 dark:text-purple-300" />
                  ...
                  <div className="col-span-full py-8 text-center text-gray-500 dark:text-secondary-400">
      ...
      >
        <div className="flex items-center justify-around h-full">
          ...
          >
            <Brain
              size={24}
              className={activeDrawer === DRAWER_TYPES.RIDDLES ? 'scale-110' : ''}
              aria-hidden="true"
            />
          ...
          >
            <FileImage
              size={24}
              className={activeDrawer === DRAWER_TYPES.IMAGE_RIDDLES ? 'scale-110' : ''}
              aria-hidden="true"
            />
