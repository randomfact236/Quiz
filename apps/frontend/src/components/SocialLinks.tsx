import type { SiteSocialLinks } from '@/types/settings.types';
...
export function SocialLinks({
  ...
  return (
    <div className="mt-4 flex items-center gap-3" aria-label="Social media links">
      {filled.map(({ key, label, href, path }) => (
        <a
          key={key}
          href={href}
          target="_blank"
          ...
          title={label}
          className="text-secondary-400 transition-colors hover:text-primary-600 dark:text-secondary-500 dark:hover:text-primary-400"
        >
