  ...
  function isFileAllowed(file: File): boolean {
    ...
    if (mime) {
      if (
        ...
        (mime.includes('json') || mime === 'text/plain' || mime === 'application/octet-stream')
      ) {
        return true;
      }
      if (
        ...
        {selectedFile ? (
          <div className="flex flex-col items-center text-center p-4">
            ...
            <button
              ...
              className="mt-3 flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-red-600 dark:text-red-300 bg-red-50 dark:bg-red-500/10 hover:bg-red-100 dark:hover:bg-red-500/20 rounded-lg transition-colors"
            >
          ...
          <div className="flex flex-col items-center text-center p-4">
            ...
            <p className="text-xs text-gray-400 dark:text-secondary-400 mt-4">
