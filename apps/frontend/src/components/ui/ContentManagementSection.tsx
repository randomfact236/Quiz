  ...
  published: [
    {
      ...
      label: 'Move to Draft',
      icon: FileEdit,
      variant: 'text-yellow-600 dark:text-yellow-400',
    },
    {
      action: 'trash',
      label: 'Move to Trash',
  ...
  trash: [
    {
      ...
      label: 'Restore',
      icon: RotateCcw,
      variant: 'text-blue-600 dark:text-blue-400',
    },
    {
      action: 'delete',
...
const EmptyState = React.memo(function EmptyState({
  ...
  return (
    ...
    >
      ...
      <h3 className="text-lg font-semibold text-gray-700 dark:text-gray-300 mb-1">{heading}</h3>
...
export const ContentManagementSection = React.memo(function ContentManagementSection({
  ...
  const filteredItems = useMemo(() => {
    if (activeFilter === 'all') {
      return items.filter((i) => i.status !== 'trash');
    }
  ...
  // ---------------------------------------------------------------------------
  return (
    <section className={cn('mt-10', className)} aria-label={`${title} management`}>
      {/* Section Header */}
      <div className="mb-5">
      ...
      >
        ...
        >
          ...
          <ChevronDown
            className="w-4 h-4 text-gray-400 dark:text-secondary-400"
            aria-hidden="true"
          />
        </div>
